...
function CartSummary({
  ...
  return (
    <>
          ...
          <div className="space-y-3">
            <div className="flex items-start gap-3 rounded-xl border border-dialac-border bg-[#faf8f4] p-4">
              ...
              <div>
                ...
                <p className="mt-1 text-xs leading-5 text-dialac-charcoal">
                  La solicitud debe realizarse al menos 3 días antes de la
                  fecha requerida.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3 rounded-xl border border-dialac-border bg-[#faf8f4] p-4">
              ...
              <div>
                ...
                <p className="mt-1 text-xs leading-5 text-dialac-charcoal">
                  Puedes enviarla a cualquier hora. DIALAC se comunicará
                  contigo dentro de sus horarios de atención.
                </p>
              </div>
            </div>
          </div>
      ...
      {/* ACCIONES FIJAS RESPONSIVE */}
      <AnimatePresence>
        {!isEmpty && !isFooterVisible && (
          <motion.div
            initial={
              reduceMotion
                ? false
            ...
            className="fixed inset-x-0 bottom-0 z-40 border-t border-dialac-border bg-white/95 px-3 py-3 shadow-[0_-10px_30px_rgba(38,40,42,0.10)] backdrop-blur-md lg:hidden"
          >
            <div className="mx-auto grid max-w-xl grid-cols-[auto_minmax(0,1fr)] gap-2">
              <Link
                to="/productos"
                aria-label="Seguir explorando productos"
                className="group inline-flex min-h-12 items-center justify-center gap-2 rounded-xl border border-dialac-brown px-3 font-semibold text-dialac-brown-dark outline-none transition hover:bg-[#f4e8de] focus-visible:ring-4 focus-visible:ring-dialac-brown/25"
              >
                <svg
                  aria-hidden="true"
                  viewBox="0 0 24 24"
