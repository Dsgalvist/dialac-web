    ...
    >
      ...
      <div className="p-6 sm:p-7">
        ...
        <motion.button
          ...
          className="group mt-6 inline-flex w-full items-center justify-center gap-3 rounded-xl bg-dialac-brown px-5 py-3.5 font-semibold text-white outline-none transition hover:bg-dialac-brown-dark focus-visible:ring-4 focus-visible:ring-dialac-brown/30 disabled:cursor-not-allowed disabled:bg-[#6f6f6f] disabled:text-white"
        >
          Continuar solicitud
